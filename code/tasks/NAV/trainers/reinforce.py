...
class ReinforceTrainer(IliadTrainer):
    ...
    def do_rollout(self, batch, student, teacher, is_eval, should_log=False):
        ...
        pred_paths, _ = student.predict(init_poses, instructions, sample=True)

        rewards = teacher.score(init_poses, pred_paths)

        student.receive(init_poses, instructions, pred_paths, rewards)
