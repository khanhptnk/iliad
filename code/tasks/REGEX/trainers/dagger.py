...
class DaggerTrainer(IliadTrainer):
    ...
    def do_rollout(self, batch, student, teacher, is_eval, should_log=False):
        ...
        pred_regexes = student.predict(src_words, instructions)

        teacher_action_seqs = teacher.demonstrate(src_words, instructions)

        student.receive(src_words, instructions, pred_regexes, teacher_action_seqs)
